...
class CaffeParamProvider():
    ...
    def bn_mean(self, name):
        return self.caffe_net.params[name][0].data / self.caffe_net.params[name][2].data # deeplab change

    def bn_variance(self, name):
        return self.caffe_net.params[name][1].data / self.caffe_net.params[name][2].data # deeplab change
...
def load_caffe(img_p, layers, caffe_fname):
    ...
    caffe_prob = net.blobs['fc1_voc12'].data[0]
...
def parse_pth_varnames(p, pth_varname, num_layers):
    ...
    elif pth_varname == 'fc1_voc12_c0.weight':
        return p.fc_weights('fc1_voc12_c0')

    elif pth_varname == 'fc1_voc12_c0.bias':
        return p.fc_biases('fc1_voc12_c0')

    elif pth_varname == 'fc1_voc12_c1.weight':
        return p.fc_weights('fc1_voc12_c1')

    elif pth_varname == 'fc1_voc12_c1.bias':
        return p.fc_biases('fc1_voc12_c1')

    elif pth_varname == 'fc1_voc12_c2.weight':
        return p.fc_weights('fc1_voc12_c2')

    elif pth_varname == 'fc1_voc12_c2.bias':
        return p.fc_biases('fc1_voc12_c2')

    elif pth_varname == 'fc1_voc12_c3.weight':
        return p.fc_weights('fc1_voc12_c3')

    elif pth_varname == 'fc1_voc12_c3.bias':
        return p.fc_biases('fc1_voc12_c3')
...
def convert(img, img_p, layers, caffe_fname, pytorch_fname):
    ...
    model = getattr(deeplab, 'resnet'+str(layers))()
    model.eval()
    ...
    model.layer4._modules['0'].conv1.register_forward_hook(hook)
    model.fc1_voc12_c0.register_forward_hook(hook)
    ...
    assert_almost_equal(caffe_model.blobs['res4b22'].data, o[6])
